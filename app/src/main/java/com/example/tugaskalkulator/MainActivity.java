...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView hasilTextView = findViewById(R.id.hasiloperasi);
        ...
        tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if((angka_pertama.getText().length()>0) && (angka_kedua.getText().length()>0))
                {
                    ...
                    hasil.setText(Integer.toString(intResult));
                    hasilTextView.setText("Hasil Penjumlahan: " + Integer.toString(intResult));
                }
                else {
        ...
        kurang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if((angka_pertama.getText().length()>0) && (angka_kedua.getText().length()>0))
                {
                    ...
                    int intResult = (int) result;
                    hasil.setText(Integer.toString(intResult));
                    hasilTextView.setText("Hasil Pengurangan: " + Integer.toString(intResult));
                }
                else {
                    Toast toast = Toast.makeText(MainActivity.this, "Mohon masukkan angka", Toast.LENGTH_LONG);
                    toast.show();
        ...
        kali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if((angka_pertama.getText().length()>0) && (angka_kedua.getText().length()>0))
                {
                    ...
                    int intResult = (int) result;
                    hasil.setText(Integer.toString(intResult));
                    hasilTextView.setText("Hasil Perkalian: " + Integer.toString(intResult));
                }
                else {
                    Toast toast = Toast.makeText(MainActivity.this, "Mohon masukkan angka", Toast.LENGTH_LONG);
                    toast.show();
        ...
        bagi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if((angka_pertama.getText().length()>0) && (angka_kedua.getText().length()>0))
                {
                    ...
                    hasilTextView.setText("Hasil Pembagian: " + result);
                }
                else {
                    Toast toast = Toast.makeText(MainActivity.this, "Mohon masukkan angka", Toast.LENGTH_LONG);
                    toast.show();
